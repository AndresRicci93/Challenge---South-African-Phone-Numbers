...
const Fetching = () => {
  ...
  return (
    ...
    <h1 style={ {color: 'green'} }>Correct Phone Numbers:</h1>
    <ul>
    ...
    <h1 style={ {color: 'green'} }>Corrected Phone Numbers - Added +27</h1>
    <ul>
      {addedprefixes.map((addedprefix) => (
        <h1 key={addedprefix.id}>{addedprefix.result}</h1>
      ))}
    </ul>
    <h1 style={ {color: 'green'} }>Corrected Phone Numbers - Changed prefix to +27 </h1>
    <ul>
    ...
    <h1 style={ {color: 'red'} }>Incorrect Phone Numbers:</h1>
    <ul>
